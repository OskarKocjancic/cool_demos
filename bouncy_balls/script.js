...
class Ball {
	...
	drawBall() {
		...
		//this.angle = -(Math.cos(this.count) * (lengthAngle / 2) + lengthAngle / 2 + startingAngle);
...
function main(params) {
	var n = 60;
	for (let i = 0; i < n; i++) {
		balls.push(new Ball(4, (Math.PI / 8) * spd * ((60 - n + i) / 60), "#" + Math.floor(Math.random() * 16777215).toString(16), (200 / n) * i + 50));
	}
